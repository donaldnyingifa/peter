                   ...
                   <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <label for="title"  >Title</label>
                          <input id="title" class="form-control"  type="text" name="title" placeholder="Enter Bug title (Eg: login not working)" value="{{$title}}"> 
                          </div>

                           <div class="form-group">
                        <label for="description" >Bug Description</label>
                          <textarea id="comment" class="form-control"  type="text" name="description" placeholder = "Enter bug description" required>{{$description}}</textarea> 
                          </div>
